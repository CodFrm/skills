...
**The two static wrap-up reviews and the fresh runtime verifier** — not for context but for isolation. `inline` mode exempts none of them; the reviews must pass before runtime verification starts.

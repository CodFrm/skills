...
Explain that `subagent` gives fresh implementer/reviewer contexts. Explain that `inline` has no independent task review, while static wrap-up still runs; runtime verification runs in the main session under either mode.
